...
export default function Welcome({ auth, canLogin, canRegister }) {
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-[#00b393] selection:text-white">
                {/* Navbar / Header */}
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center h-20">
                            ...
                            <div className="flex-shrink-0 flex items-center gap-3 cursor-pointer group">
                                <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#008f75] to-[#00b393] flex items-center justify-center shadow-lg shadow-[#00b393]/30 group-hover:scale-105 transition-transform duration-300">
                                    <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                    </svg>
                                </div>
                                <span className="font-bold text-xl tracking-tight text-gray-900 group-hover:text-[#008f75] transition-colors">
                                    SGA<span className="text-[#00b393]"> ENGEATIVOS</span>
                                </span>
                            </div>
                            ...
                            <nav className="flex items-center gap-4 hidden sm:flex">
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="font-medium text-sm text-gray-600 hover:text-[#00b393] transition-colors px-4 py-2 hover:bg-[#f0f9f8] rounded-full"
                                    >
                                        Acessar Central
                                    </Link>
                                ) : (
                                    <>
                                        ...
                                        {canRegister && (
                                            <Link
                                                href={route('register')}
                                                className="font-semibold text-sm bg-gray-900 text-white hover:bg-[#00b393] transition-all duration-300 px-6 py-2.5 rounded-full shadow-md hover:shadow-lg hover:-translate-y-0.5"
                                            >
                                                Cadastre-se
                                            </Link>
                                        )}
                ...
                <main className="pt-32 pb-16 sm:pt-40 sm:pb-24 lg:pb-32 overflow-hidden">
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <div className="absolute top-0 -translate-y-12 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-tr from-[#00b393]/20 to-[#6690f4]/20 blur-[100px] rounded-full pointer-events-none -z-10"></div>

                        <h1 className="mx-auto max-w-4xl font-extrabold text-5xl tracking-tight text-slate-900 sm:text-7xl mb-8 leading-tight">
                            Gestão multiempresa{' '}
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#008f75] to-[#6690f4]">
                        ...
                        <div className="flex justify-center gap-4 flex-col sm:flex-row">
                            {auth.user ? (
                                <Link
                                    href={route('dashboard')}
                                    className="inline-flex justify-center items-center gap-2 bg-[#00b393] hover:bg-[#008f75] text-white font-semibold text-lg px-8 py-3.5 rounded-full transition-all shadow-lg shadow-[#00b393]/30 hover:shadow-xl hover:-translate-y-1"
                                >
                                    Ir para a Central
                    ...
                    <div className="mt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            {/* Feature 1 */}
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-[#c1ede5] transition-all duration-300 group">
                                <div className="w-12 h-12 bg-[#f0f9f8] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                                    <svg className="w-6 h-6 text-[#00b393]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-[#c1ede5] transition-all duration-300 group">
                                <div className="w-12 h-12 bg-[#f0f4ff] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                                    <svg className="w-6 h-6 text-[#6690f4]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                    </svg>
                                </div>
                ...
                <footer className="border-t border-gray-200 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        <div className="flex items-center gap-2">
                            <span className="font-bold text-gray-900">SGA<span className="text-[#00b393]"> ENGEATIVOS</span></span>
