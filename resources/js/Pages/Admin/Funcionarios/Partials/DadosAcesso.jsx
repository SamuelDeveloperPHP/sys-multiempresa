        ...
        <div className="animate-fade-in-up">
            <div className="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden mb-6">
                <div className="bg-gray-50 px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                    ...
                    {linkedUser && (
                        <span className="px-3 py-1 bg-emerald-100 text-emerald-800 text-xs font-bold rounded-full">Conta Ativa</span>
                    )}
                </div>
                    ...
                    {!linkedUser ? (
                        <div className="text-center py-8">
                            ...
                            <a 
                                ...
                                className="inline-flex items-center justify-center px-6 py-2.5 bg-[#00b393] hover:bg-[#008f75] text-white font-bold rounded-lg shadow-md transition-all"
                            >
                                ...
                                <div className="bg-blue-50 rounded-xl p-5 border border-blue-100">
                                    ...
                                    <ul className="space-y-2 text-sm text-blue-900/80">
                                        <li className="flex items-start gap-2">
                                            <svg className="w-4 h-4 text-emerald-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
