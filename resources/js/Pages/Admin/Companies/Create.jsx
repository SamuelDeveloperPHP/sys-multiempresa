...
export default function Create({ pageTitle, formAction, cancelRoute }) {
    ...
    const fetchCnpj = async () => {
        ...
        try {
            ...
            setData(currentData => ({
                ...
                name: currentData.name || fetchedNomeFantasia, // Preenche 'name' automaticamente se estiver vazio
        ...
        <AuthenticatedLayout header={pageTitle}>
            ...
            <div className="max-w-4xl bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
                <form onSubmit={submit} className="space-y-8">
                    ...
                    <div>
                        <h4 className="text-base font-semibold text-gray-800 border-b border-gray-100 pb-2 mb-4">Dados Principais da Empresa</h4>
                    ...
                    <div className="flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
                        <Link href={route(cancelRoute)} className="text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors">
                            Cancelar
                        </Link>
                        <button
                            type="submit"
